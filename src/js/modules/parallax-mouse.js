            ...
            parallaxMouse.forEach(el => {
                ...
                function mouseMoveParallax(wrapper = window) {
                    wrapper.addEventListener("mousemove", function (e) {
                        const offsetTop = el.getBoundingClientRect().top + this.window.scrollY;
                        if(offsetTop >= this.window.scrollY || (offsetTop + el.offsetHeight) >= this.window.scrollY) {
